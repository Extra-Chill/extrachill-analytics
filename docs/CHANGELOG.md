...
### Fixed
- read and write link page analytics on the link page storage site

## [0.38.0] - 2026-09-23

### Added
- generic cta_click / form_submit events with no per-button code

## [0.37.2] - 2026-09-23

### Changed
- track package-lock.json so the release train can resolve npm dependencies

### Fixed
- resolve the Link Page post type through the storage-aware runtime
...
### Changed
- adopt the managed WordPress harness, delete the 1,020-line fake-WordPress bootstrap

### Fixed
- accept custom public link-page hosts in the pageview origin gate

## [0.36.3] - 2026-08-22

### Fixed
- classify trustworthy conversion outcomes
- accept cached route pageview sentinel
- preserve relative link analytics windows

## [0.36.2] - 2026-08-21

### Fixed
- declare pageview Jest globals
- preserve anonymous calendar pageviews

## [0.36.1] - 2026-08-19

### Fixed
- clear schema readiness static analysis
- scope network density to Extra Chill hosts
- prepare analytics schema before frontend writes
...
### Added
- add shared analytics date range runtime

### Fixed
- clear date range release lint

## [0.34.0] - 2026-08-04

### Added
- filter conversion analytics by author

### Fixed
- align conversion map release lint
- establish release lint baseline

## [0.33.0] - 2026-08-02

### Added
- define onboarding artist access grant event

### Changed
- cache expensive network analytics reports

## [0.32.1] - 2026-07-18

### Fixed
- sanitize outbound analytics source URLs
